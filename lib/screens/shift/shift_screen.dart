      ...
      child: SizedBox(
        ...
        child: FilledButton(
          ...
          style: FilledButton.styleFrom(
            ...
            backgroundColor: const Color.fromARGB(255, 255, 95, 2),
          ),
          child: Row(
            children: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            _shiftButton(day: "9/10", title: "体育祭", onPressed: () => Navigator.of(context).pushNamed(TaiikusaiShiftScreen.routeName)),
            _shiftButton(
              day: "9/14",
              title: "文化祭1日目",
