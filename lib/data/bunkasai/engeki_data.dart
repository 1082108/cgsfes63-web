...
class EngekiData {
  static const List<EngekiDetailData> engekiDataList = [
    EngekiDetailData(
      ...
      startTime: Time(day: GakusaiDay.bunkasai1, hour: 13, minute: 5),
      endTime: Time(day: GakusaiDay.bunkasai1, hour: 14, minute: 00),
    ),
    EngekiDetailData(
      hr: "302",
    ...
    EngekiDetailData(
      ...
      endTime: Time(day: GakusaiDay.bunkasai2, hour: 11, minute: 00),
    ),
    EngekiDetailData(
      hr: "308",
      title: "インサイドヘッド",
